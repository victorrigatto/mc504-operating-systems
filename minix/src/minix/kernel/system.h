...
/* mutex */
int do_mutex_init(struct proc * caller, message *m_ptr);
#if ! USE_MUTEX_INIT
#define do_mutex_init NULL
#endif

int do_mutex_destroy(struct proc * caller, message *m_ptr);
#if ! USE_MUTEX_DESTROY
#define do_mutex_destroy NULL
#endif

int do_mutex_lock(struct proc * caller, message *m_ptr);
#if ! USE_MUTEX_LOCK
#define do_mutex_lock NULL
#endif

int do_mutex_unlock(struct proc * caller, message *m_ptr);
#if ! USE_MUTEX_UNLOCK
#define do_mutex_unlock NULL
#endif
